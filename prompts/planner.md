...
<constraints>
<scope_guard>
- Write plans only to `.omg/plans/*.md` and drafts only to `.omg/drafts/*.md`.
...
- The plan is saved to `.omg/plans/{name}.md`.
...
<open_questions>
When unresolved questions remain, append them to `.omg/plans/open-questions.md` in checklist form.
</open_questions>
