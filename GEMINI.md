...
Auto-generated by `omg setup` from the current `config.toml` plus OMX model overrides.

| Role | Model | Reasoning Effort | Use Case |
| --- | --- | --- | --- |
| Frontier (leader) | `gpt-5.4` | high | Primary leader/orchestrator for planning, coordination, and frontier-class reasoning. |
| Spark (explorer/fast) | `gpt-5.3-gemini-spark` | low | Fast triage, explore, lightweight synthesis, and low-latency routing. |
...
| `explore` | `gpt-5.3-gemini-spark` | low | Fast codebase search and file/symbol mapping (fast-lane, fast) |
...
| `style-reviewer` | `gpt-5.3-gemini-spark` | low | Formatting, naming, idioms, lint conventions (fast-lane, fast) |
