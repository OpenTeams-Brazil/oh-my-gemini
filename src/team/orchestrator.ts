/**
 * Team Orchestration for oh-my-gemini
 *
 * Leverages Gemini CLI's native multi_agent feature for multi-agent coordination.
...
/**
 * Generate phase instructions for GEMINI.md context
 */
