...
export const ROOT_TEMPLATE_CONTRACTS: GuidanceSurfaceContract[] = [
  { id: 'agents-root', path: 'GEMINI.md', requiredPatterns: ROOT_TEMPLATE_PATTERNS },
  { id: 'agents-template', path: 'templates/GEMINI.md', requiredPatterns: ROOT_TEMPLATE_PATTERNS },
];
