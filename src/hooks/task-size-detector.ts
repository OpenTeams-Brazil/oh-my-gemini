 ...
 *   3. Future hook readiness — will be promoted to runtime enforcement when Gemini CLI
 *      adds pre-hook support
 *
 * The actual gate enforcement in OMX is advisory: GEMINI.md instructs the model to
