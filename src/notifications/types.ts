...
export interface FullNotificationPayload {
  ...
  /** Agent name (populated by extensibility plugins, not set by core Gemini CLI hooks) */
  agentName?: string;
  /** Agent type (populated by extensibility plugins, not set by core Gemini CLI hooks) */
  agentType?: string;
}
