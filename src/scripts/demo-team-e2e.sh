...
# with mixed Gemini/Claude workers. It performs a complete end-to-end test
...
omg team api mailbox-mark-notified --input "$MARK_INPUT" --json >/dev/null
omg team api mailbox-mark-delivered --input "$MARK_INPUT" --json >/dev/null
