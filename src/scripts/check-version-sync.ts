...
const explore = TOML.parse(readFileSync(join(root, 'crates', 'omg-explore', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
const runtimeCore = TOML.parse(readFileSync(join(root, 'crates', 'omg-runtime-core', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
const mux = TOML.parse(readFileSync(join(root, 'crates', 'omg-mux', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
const runtime = TOML.parse(readFileSync(join(root, 'native', 'omg-runtime', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
const sparkshell = TOML.parse(readFileSync(join(root, 'native', 'omg-sparkshell', 'Cargo.toml'), 'utf-8')) as Record<string, unknown>;
...
if ((explore.package as Record<string, unknown>)?.version !== undefined && ((explore.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('crates/omg-explore/Cargo.toml must use version.workspace = true');
}
if ((runtimeCore.package as Record<string, unknown>)?.version !== undefined && ((runtimeCore.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('crates/omg-runtime-core/Cargo.toml must use version.workspace = true');
}
if ((mux.package as Record<string, unknown>)?.version !== undefined && ((mux.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('crates/omg-mux/Cargo.toml must use version.workspace = true');
}
if ((runtime.package as Record<string, unknown>)?.version !== undefined && ((runtime.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('native/omg-runtime/Cargo.toml must use version.workspace = true');
}
if ((sparkshell.package as Record<string, unknown>)?.version !== undefined && ((sparkshell.package as Record<string, unknown>).version as Record<string, unknown>)?.workspace !== true) {
  problems.push('native/omg-sparkshell/Cargo.toml must use version.workspace = true');
}
