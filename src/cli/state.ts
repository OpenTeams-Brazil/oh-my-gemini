...
const STATE_HELP = `Usage: omg state <read|write|clear|list-active|get-status> [--input <json>] [--json]\n\nExamples:\n  omg state read --input '{"mode":"ralph"}' --json\n  omg state write --input '{"mode":"ralph","active":true,"current_phase":"executing"}' --json\n  omg state clear --input '{"mode":"ralph","all_sessions":true}' --json\n  omg state list-active --json\n  omg state get-status --input '{"mode":"ralph"}' --json`;
