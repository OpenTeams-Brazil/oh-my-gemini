 ...
 *
 * Mirrors OMG #1130 pipeline design with OMX-specific adaptations:
 * - Execution backend is always teams (Gemini CLI workers)
 ...
 * This is the canonical OMX pipeline matching the OMG #1130 design.
 */
