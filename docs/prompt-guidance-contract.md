...
This document explains the **behavioral prompt contract** introduced by the GPT-5.4 guidance rollout in [#608](https://github.com/Yeachan-Heo/oh-my-gemini/issues/608) and expanded in [#611](https://github.com/Yeachan-Heo/oh-my-gemini/pull/611) and [#612](https://github.com/Yeachan-Heo/oh-my-gemini/pull/612).
...
Issue [#615](https://github.com/Yeachan-Heo/oh-my-gemini/issues/615) uses examples like `src/prompts/role-planner.ts`, but the current prompt sources in this repository live in **`prompts/*.md`**, then get installed to `~/.gemini/prompts/`.

The GPT-5.4 contract is currently distributed across:

- orchestration surfaces: `GEMINI.md`, `templates/GEMINI.md`
- canonical XML-tagged subagent role prompt surfaces: `prompts/*.md`
- generated top-level Gemini config guidance: `src/config/generator.ts`
...
| Surface | Evidence |
|---|---|
| `GEMINI.md` | `GEMINI.md:29` |
| `templates/GEMINI.md` | `templates/GEMINI.md:29` |
...
| Surface | Evidence |
|---|---|
| `GEMINI.md` | `GEMINI.md:30` |
| `templates/GEMINI.md` | `templates/GEMINI.md:30` |
...
| Surface | Evidence |
|---|---|
| `GEMINI.md` | `GEMINI.md:31`, `GEMINI.md:300` |
| `templates/GEMINI.md` | `templates/GEMINI.md:31`, `templates/GEMINI.md:300` |
...
| Surface | Evidence |
|---|---|
| `GEMINI.md` | `GEMINI.md:32`, `GEMINI.md:288`, `GEMINI.md:297-301`, `GEMINI.md:307-308` |
| `templates/GEMINI.md` | `templates/GEMINI.md:32`, `templates/GEMINI.md:288`, `templates/GEMINI.md:297-301`, `templates/GEMINI.md:307-308` |
| `src/config/generator.ts` | `src/config/generator.ts:77` |
...
When editing `GEMINI.md`, `templates/GEMINI.md`, or other root orchestration guidance, keep the orchestration contract mode-driven and terse:
...
|---|---|
| GPT-5.4 prompt behavior contract | `GEMINI.md`, `templates/GEMINI.md`, canonical XML-tagged role prompt surfaces in `prompts/*.md`, `src/config/generator.ts`, `src/hooks/__tests__/prompt-guidance-*.test.ts` |
...
- Implementation issue: [#608](https://github.com/Yeachan-Heo/oh-my-gemini/issues/608)
- Documentation issue: [#615](https://github.com/Yeachan-Heo/oh-my-gemini/issues/615)
