...
Representative PRs:
- [#619](https://github.com/Yeachan-Heo/oh-my-gemini/pull/619) — XML-tag prompt migration
- [#620](https://github.com/Yeachan-Heo/oh-my-gemini/pull/620) — prompt-guidance contract documentation
- [#623](https://github.com/Yeachan-Heo/oh-my-gemini/pull/623) — 2-layer orchestrator / role-prompt documentation
- [#625](https://github.com/Yeachan-Heo/oh-my-gemini/pull/625) — leader-only orchestration boundaries
...
PR: [#624](https://github.com/Yeachan-Heo/oh-my-gemini/pull/624)
...
PRs: [#626](https://github.com/Yeachan-Heo/oh-my-gemini/pull/626), [#627](https://github.com/Yeachan-Heo/oh-my-gemini/pull/627)
...
- adds `src/cli/__tests__/package-bin-contract.test.ts` so the global-install `omg` entrypoint stays covered in CI

PR: [#633](https://github.com/Yeachan-Heo/oh-my-gemini/pull/633)
...
PR: [#616](https://github.com/Yeachan-Heo/oh-my-gemini/pull/616)
