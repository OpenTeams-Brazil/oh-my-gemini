...
Authoritative workflow state lives in per-mode files under `.omg/state/`:

- root scope: `.omg/state/<mode>-state.json`
- session scope: `.omg/state/sessions/<session_id>/<mode>-state.json`

Examples:

- `.omg/state/ralplan-state.json`
- `.omg/state/sessions/<session_id>/ralph-state.json`
- `.omg/state/team-state.json`
...
- `.omg/state/sessions/<session_id>/skill-active-state.json`
