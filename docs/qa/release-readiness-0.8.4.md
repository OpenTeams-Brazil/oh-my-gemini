...
| Version smoke | `node bin/omg.js version` | PASS (`oh-my-gemini v0.8.4`) |
| Doctor smoke | `node bin/omg.js doctor` | PASS (`9 passed, 0 warnings, 0 failed`) |
...
- This is a focused patch release centered on `omg setup` refresh behavior and managed model upgrade prompting.
