...
- native Gemini hook ownership and lifecycle continuity (`src/scripts/codex-native-hook.ts`, `src/config/codex-hooks.ts`, `src/cli/setup.ts`, `docs/codex-native-hooks.md`)
