...
- PR [#806](https://github.com/Yeachan-Heo/oh-my-gemini/pull/806) hotfix (`d86165d`) for smoke hydration asset localization
...
| Packed tarball dry run | `npm pack --dry-run` | PASS (`oh-my-gemini-0.9.1.tgz`) |
...
- dry-run tarball produced `oh-my-gemini-0.9.1.tgz`
