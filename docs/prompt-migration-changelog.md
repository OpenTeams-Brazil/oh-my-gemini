...
## Orchestration Brain Migration (`GEMINI.md`, `templates/GEMINI.md`)

### Summary

These files are the instruction root that OMX expects Gemini to follow across a workspace.
Changes here are primarily about aligning instructions with Gemini CLI tool contracts.

### Key Deltas

- Updated child-agent delegation guidance to reflect the Gemini `spawn_agent` API:
...
- `templates/GEMINI.md` header normalized to match `GEMINI.md` and removed the non-compliant template opener.

### Diff Stats

| File | Added | Removed | Notes |
|---|---:|---:|---|
| `GEMINI.md` | 42 | 10 | Tooling + delegation guidance expanded; semantics preserved. |
| `templates/GEMINI.md` | 7 | 7 | Header/tone normalized; still intended as a template copy. |
...
- Added explicit schema-contract sections to:
  - `GEMINI.md`
  - `templates/GEMINI.md`
- Normalized worker task guidance in `GEMINI.md` runtime worker overlay:
...
- One meaningful correction was made: the "agent teams" enablement guidance in `skills/omg-setup/SKILL.md` was updated to enable Gemini features via `~/.gemini/config.toml` rather than legacy `settings.json` env vars.

### Per-File Matrix

| Skill File | Added | Removed | Structural Highlights | Behavior Delta |
|---|---:|---:|---|---|
| `skills/analyze/SKILL.md` | 1 | 1 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/autopilot/SKILL.md` | 11 | 16 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/code-review/SKILL.md` | 1 | 1 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
...
| `skills/doctor/SKILL.md` | 47 | 45 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/ecomode/SKILL.md` | 1 | 1 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/frontend-ui-ux/SKILL.md` | 2 | 2 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/help/SKILL.md` | 1 | 1 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/learner/SKILL.md` | 5 | 5 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/omg-setup/SKILL.md` | 144 | 156 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/plan/SKILL.md` | 1 | 1 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/project-session-manager/SKILL.md` | 5 | 5 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/release/SKILL.md` | 3 | 3 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/research/SKILL.md` | 10 | 15 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/security-review/SKILL.md` | 1 | 1 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/skill/SKILL.md` | 20 | 20 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/tdd/SKILL.md` | 1 | 1 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/ultrapilot/SKILL.md` | 11 | 16 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |
| `skills/writer-memory/SKILL.md` | 1 | 1 | Gemini path/terminology normalization; examples updated to Gemini-first conventions. | No direct runtime behavior change; instruction correctness improved. |

### Hotspots Worth Reviewing

- `skills/omg-setup/SKILL.md`: largest edit surface; includes team enablement guidance (`~/.gemini/config.toml` `[features]` flags) and teammate display preference storage (`~/.gemini/.omg-config.json`).
