...
<p align="center">
  <img src="https://raw.githubusercontent.com/Yeachan-Heo/oh-my-gemini/v0.9.1/docs/shared/omg-character-spark-initiative.jpg" alt="OMX character sparked for the Spark Initiative" width="720">
</p>
...
- The required packed-install smoke hydration fix landed later on `dev` in PR [#806](https://github.com/Yeachan-Heo/oh-my-gemini/pull/806).
