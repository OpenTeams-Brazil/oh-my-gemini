...
- Prevents non-Gemini default models such as `gpt-5.3-gemini-spark` from being passed through to Gemini workers unless the configured model is explicitly a Gemini model (`#585`).
