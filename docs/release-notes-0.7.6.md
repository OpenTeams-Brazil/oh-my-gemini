...
- `refactor(mcp): extract omg_run_team_* to dedicated team-server.ts` (#431)
...
| `node bin/omg.js --help` | 0 | CLI usage rendered |
| `node bin/omg.js doctor` | 0 | `Results: 9 passed, 0 warnings, 0 failed` |
| `node bin/omg.js version` | 0 | `oh-my-gemini v0.7.6` |
| `node bin/omg.js status` | 0 | mode status rendered |
| `node bin/omg.js setup --dry-run` | 0 | dry-run setup completed |
| `node bin/omg.js cancel` | 0 | cancel command completed |
