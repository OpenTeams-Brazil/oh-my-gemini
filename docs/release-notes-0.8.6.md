...
This release adds:
- additive `wake_on=event` / `after_event_id` support to `omg_run_team_wait`
...
- `omg team await <team-name>` CLI support
...
PR: [#609](https://github.com/Yeachan-Heo/oh-my-gemini/pull/609)
...
Core-surface pass ([#611](https://github.com/Yeachan-Heo/oh-my-gemini/pull/611), addresses [#608](https://github.com/Yeachan-Heo/oh-my-gemini/issues/608)):
- root `GEMINI.md`
- `templates/GEMINI.md`
- `prompts/executor.md`
- `prompts/planner.md`
...
Expansion pass ([#612](https://github.com/Yeachan-Heo/oh-my-gemini/pull/612), follow-up to [#611](https://github.com/Yeachan-Heo/oh-my-gemini/pull/611)):
...
PR: [#610](https://github.com/Yeachan-Heo/oh-my-gemini/pull/610)
